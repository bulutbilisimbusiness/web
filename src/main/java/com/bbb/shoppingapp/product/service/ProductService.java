...
import com.bbb.shoppingapp.product.model.product.ProductDetailResponse;
...
import com.bbb.shoppingapp.product.model.ProductSellerResponse;
import com.bbb.shoppingapp.product.repository.mongo.ProductRepository;
...
import static com.bbb.shoppingapp.product.domain.ProductImage.ImageType.FEATURE;
...
public class ProductService {
    ...
    public Flux<ProductResponse> getAll() {
        return productEsService.findAll()
                .doOnNext(item -> log.info("Fetched item from Elasticsearch: {}", item))
                .map(this::mapToDto)
